...
import { getMessagesByCount, useSendMessageReversed} from "@/app/messageHandlers";
import { useMessageCount } from "@/app/MessageContext";

export default function TranslateWithPaddingReversedScreen() {
    ...
    const handleSendMessage = useSendMessageReversed(
        messages,
        setMessages,
        inputText,
        setInputText,
                ...
                options={{
                    headerTitle: () => (
                        <View style={{alignItems: "center"}}>
                            ...
                            <Text style={{fontSize: 12, color: "#666"}}>translate-with-padding | Start with bottom</Text>
                        </View>
                    ),
                }}
            />
